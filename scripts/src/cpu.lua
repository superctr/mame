...
if CPUS["H8500"] then
	files {
		...
		MAME_DIR .. "src/devices/cpu/h8500/h8570.cpp",
		MAME_DIR .. "src/devices/cpu/h8500/h8570.h",
		MAME_DIR .. "src/devices/cpu/h8500/h8570_pwm.cpp",
		MAME_DIR .. "src/devices/cpu/h8500/h8570_pwm.h",
...
if CPUS["SH"] then
	files {
		...
		MAME_DIR .. "src/devices/cpu/sh/sh7034.cpp",
		MAME_DIR .. "src/devices/cpu/sh/sh7034.h",
		...
		MAME_DIR .. "src/devices/cpu/sh/sh_wdt.cpp",
		MAME_DIR .. "src/devices/cpu/sh/sh_wdt.h",
		MAME_DIR .. "src/devices/cpu/sh/sh_intc.cpp",
		MAME_DIR .. "src/devices/cpu/sh/sh_intc.h",
		MAME_DIR .. "src/devices/cpu/sh/sh_itu.cpp",
		MAME_DIR .. "src/devices/cpu/sh/sh_itu.h",
		MAME_DIR .. "src/devices/cpu/sh/sh_mcu.cpp",
		MAME_DIR .. "src/devices/cpu/sh/sh_mcu.h",
